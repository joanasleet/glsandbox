...
${OBJECTDIR}/Deallocator.o: Deallocator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Deallocator.o Deallocator.cpp
...
${OBJECTDIR}/ShaderCache.o: ShaderCache.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ShaderCache.o ShaderCache.cpp

${OBJECTDIR}/ShaderUtil.o: ShaderUtil.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ShaderUtil.o ShaderUtil.cpp
